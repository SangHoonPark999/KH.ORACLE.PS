...
ALTER TABLE LEAVE_BALANCE MODIFY REMAIN_DAY NULL;

COMMIT;

INSERT INTO LEAVE_BALANCE VALUES (LEAVE_BALANCE_SEQ.NEXTVAL,  41, SYSDATE, 13);

SELECT * FROM LEAVE_BALANCE B, EMPLOYEE E WHERE (B.EMP_NO = E.EMP_NO) AND B.REMAIN_DAY = NULL;

DELETE FROM EMPLOYEE WHERE EMP_NO = 41;

ALTER TABLE LEAVE_BALANCE ADD CONSTRAINT BAL_EMP_NO_FK FOREIGN KEY(EMP_NO)
REFERENCES EMPLOYEE(EMP_NO) ON DELETE CASCADE;

ALTER TABLE LEAVE_BALANCE DROP CONSTRAINT BAL_EMP_NO_FK;

SELECT * FROM EMPLOYEE E, LEAVE_REQUEST R WHERE E.EMP_NO = R.EMP_NO;

SELECT ...
FROM EMPLOYEE E
JOIN LEAVE_REQUEST R ON E.EMP_NO = R.EMP_NO;
