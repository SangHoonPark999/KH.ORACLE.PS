...
UPDATE BOOKS SET TITLE = 'FQF',PUBLISHER = '222', YEAR = '124', PRICE = 20000 WHERE BOOK_ID = 1;
...
SELECT * FROM PRODUCT;
commit;
ISERT INTO PRODUCT VALUES ('','','', , );
DELETE FROM PRODUCT WHERE PCODE = 'A00006';
UPDATE PRODUCT SET PNAME = '가스터빈', PCOMPANY = '삼성', PPRICE = 1500000, STOCK = 2;
